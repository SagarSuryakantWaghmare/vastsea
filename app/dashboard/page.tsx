    ...
    <div className="container py-10">
      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <Button asChild>
            <Link href="/add">Add New Problem</Link>
          </Button>
        </div>
          ...
          <TabsContent value="problems">
            <Card>
              <CardHeader>
                <CardTitle>My Problems</CardTitle>
                <CardDescription>
                  Manage problems you've created or bookmarked.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {userProblems.length > 0 ? (
                  ...
                  <div className="text-center py-10">
                    <p className="text-muted-foreground mb-4">You haven't created any problems yet.</p>
                    <Button asChild>
                      <Link href="/add">Create Your First Problem</Link>
                    </Button>
                  </div>
